...
public class NewFragment extends Fragment implements View.OnClickListener {
    ...
    private EditText dataFromFragment;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        dataFromFragment = (EditText)v.findViewById(R.id.id_editText_Fragment);
        sendButton = (Button)v.findViewById(R.id.id_button_fragment);
    ...
    public void onClick(View view) {
        listner.dataTransfer(dataFromFragment.getText().toString());
